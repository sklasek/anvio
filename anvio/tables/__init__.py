...
trnaseq_sequences_table_structure       = ['name', 'read_count', 'profiled_or_mapped', 'truncated_profile', 'sequence']
trnaseq_sequences_table_types           = ['str' , 'numeric'   , 'numeric'           , 'numeric'          , 'str']
...
trnaseq_trimmed_table_structure         = ['name', 'unique_seq_count', 'read_count', 'profiled_or_mapped', 'truncated_profile', 'truncated_profile_recovered_by_dereplication', 'sequence', 'normalized_seq_representation', 'fiveprime_unique_seq_count', 'fiveprime_read_count'] + [threeprime_variant + '_read_count' for threeprime_variant in THREEPRIME_VARIANTS]
trnaseq_trimmed_table_types             = ['str' , 'numeric'         , 'numeric'   , 'numeric'           , 'numeric'          , 'numeric'                                     , 'str'     , 'numeric'                      , 'numeric'                   , 'numeric'             ] + ['numeric' for _ in THREEPRIME_VARIANTS]

trnaseq_normalized_table_name           = 'normalized'
trnaseq_normalized_table_structure      = ['name', 'trimmed_seq_count', 'mean_specific_coverage', 'mean_nonspecific_coverage', 'specific_coverages', 'nonspecific_coverages', 'modified_seq_representation', 'specific_read_count', 'nonspecific_read_count', 'profile_changed_by_del_analysis', 'truncated_profile_recovered_by_del_analysis', 'count_of_specific_reads_with_extra_fiveprime', 'count_of_nonspecific_reads_with_extra_fiveprime', 'specific_mapped_read_count', 'nonspecific_mapped_read_count', 'specific_longer_fiveprime_extensions', 'specific_longer_fiveprime_extension_read_counts', 'nonspecific_longer_fiveprime_extensions', 'nonspecific_longer_fiveprime_extension_read_counts'] + [threeprime_variant + '_specific_read_count' for threeprime_variant in THREEPRIME_VARIANTS] + [threeprime_variant + '_nonspecific_read_count' for threeprime_variant in THREEPRIME_VARIANTS]
trnaseq_normalized_table_types          = ['str' , 'numeric'          , 'numeric'               , 'numeric'                  , 'str'               , 'str'                  , 'numeric'                    , 'numeric'            , 'numeric'               , 'numeric'                        , 'numeric'                                    , 'numeric'                                     , 'numeric'                                        , 'numeric'                   , 'numeric'                      , 'str'                                 , 'str'                                            , 'str'                                    , 'str'                                               ] + ['numeric' for _ in THREEPRIME_VARIANTS                                                  ] + ['numeric' for _ in THREEPRIME_VARIANTS]
